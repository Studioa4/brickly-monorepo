...
import CatastoSearch from "./pages/CatastoSearch";
import TestTabella from './pages/TestTabella';
  ...
  return (
      <Routes>
        ...
        >
          ...
          <Route path="/catastosearch" element={<CatastoSearch />} />
          <Route path="impostazioni" element={<ImpostazioniUtente />} />
          <Route path="/test-tabella" element={<TestTabella />} />
        </Route>
      </Routes>
  );
}
