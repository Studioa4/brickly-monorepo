...
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        await pool.query('UPDATE utenti_studio SET otp_code = $1, otp_expires_at = $2 WHERE id = $3', [otp, expiresAt, user.id]);
...
router.post('/verify-otp', async (req, res) => {
    ...
    try {
        ...
        await pool.query('UPDATE utenti_studio SET otp_code = NULL, otp_expires_at = NULL WHERE id = $1', [user.id]);
